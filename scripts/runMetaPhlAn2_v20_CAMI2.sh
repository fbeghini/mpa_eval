...
do
    echo $ds
    OUTPATH=/shares/CIBIO-Storage/CM/mir/projects/fbeghini_CAMIEval/CAMI_II/${ds}/mpa2_v20/
    mkdir -p ${OUTPATH}
...
OUTPATH=/shares/CIBIO-Storage/CM/mir/projects/fbeghini_CAMIEval/CAMI_II/MOUSEGUT/mpa2_v20/
mkdir -p ${OUTPATH}
